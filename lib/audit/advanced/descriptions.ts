...
export const DESC = {
  ...
  llms_txt: `Le llms.txt est un fichier Markdown placé à la racine du site, pensé pour guider les IA génératives (ChatGPT, Perplexity, Gemini, Claude) vers les pages les plus importantes. C'est l'équivalent du robots.txt mais à destination des LLMs, et s'inscrit dans le GEO (Generative Engine Optimization). Sa mise en place est rapide et sans risque, et positionne le site en avance sur une pratique qui se standardise : plus de 844 000 sites l'ont déjà adopté, dont Anthropic, Cloudflare, Stripe et Perplexity.`,
