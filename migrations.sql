...
ALTER TABLE jobs ADD COLUMN IF NOT EXISTS do_refinement BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE jobs ADD COLUMN IF NOT EXISTS do_schema_jsonld BOOLEAN NOT NULL DEFAULT FALSE;
...
ALTER TABLE semantic_reports ADD COLUMN IF NOT EXISTS competitors_breakdown JSONB;
